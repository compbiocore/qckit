...
# qckit build configuration file, created by
# `ablog start` on Fri Jun 29 15:28:21 2018.
#
...
blog_authors = {
    'August Guang': ('August Guang', None),
}
...
project = u'qckit'
copyright = u'2018, August Guang'
author = u'August Guang'
